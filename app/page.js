        ...
        <main className="flex flex-col items-center min-h-screen px-4 py-20 md:px-24 relative overflow-hidden text-neutral-200">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 backdrop-blur-xl bg-black/40 border-b border-white/5 transition-all">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Button variant="secondary" size="sm" className="bg-white text-black hover:bg-gray-200" onClick={() => scrollToSection('transfer-tool')}>Sign In</Button>
                </div>
            </nav>

            {/* Hero Section */}
            <div className="flex flex-col items-center text-center max-w-4xl mt-20 mb-24 space-y-8 animate-in fade-in slide-in-from-bottom-10 duration-1000">
            ...
            {/* Main Widget */}
            <div id="transfer-tool" className="w-full max-w-3xl z-10 mb-32 scroll-mt-32">
...
function FeatureCard({ icon, title, description }) {
    return (
        <Card className="p-6 flex flex-col items-start gap-4 bg-white/5 border-white/10 hover:bg-white/10 transition-colors duration-300">
